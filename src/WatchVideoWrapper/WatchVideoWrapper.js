...
import classes from './WatchVideoWrapper.module.css';
import axios from 'axios'
class WatchVideoWrapper extends Component{
    state={
        data:{},
        isLiked: false,
        isSaved: false
...
/*        return (
		...
		{data.title}
						...
						There is no other way but to commit wholeheartedly
						to a relationship with a croissant. 
						We have all found ourselves at the mercy 
						of its allure. Here, in another epic film 
						by the uber talented Nathan Rodger, 
						our Erin divulges her personal romance 
						with The Croissant.</p>
                    </div>
                </div>
               </div>
            </div>
